...
export default function WorkoutsPage() {
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
      <PageHeader
        title="Workout Plans"
        description="Generate, preview, and download custom AI-powered workout & diet plan PDFs."
        action={
      ...
      {pdfUrl ? (
        <div className="space-y-4">
          ...
          <div className="h-[750px] w-full overflow-hidden rounded-2xl border border-slate-200 bg-slate-900 shadow-sm">
            <iframe
              ...
              title="Workout Plan PDF Preview"
            />
          </div>
        </div>
      ) : (
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
          ...
          <p className="text-sm text-slate-500 max-w-md mx-auto mt-1 mb-4">
            Click on "Generate AI Plan PDF" to create custom workout schedules,
